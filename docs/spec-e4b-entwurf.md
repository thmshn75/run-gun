...
> Vorbereitet am 2026-08-20. Zwei Gegenprüfungen (Premortem, Betriebssicht) sind
> eingearbeitet — ihre Befunde stehen **in** den betroffenen Abschnitten, nicht als Liste
> am Ende. Wird nach Thomas' Freigabe unverändert nach `docs/active-task.md` übernommen
> und auf `SPEC_READY` gesetzt.
